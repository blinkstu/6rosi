...
//$codepay_config['notify_url'] = $codepay_config['path'] . '/main/codepay';
...
define('DB_USER', '6rosi'); //数据库用户名
define('DB_PWD', '6rosi'); //数据库密码
define('DB_NAME', '6rosi'); //数据库名称
 ...
 *
 */
define('DB_USERTABLE', 'cmf_user'); //充值用户所在数据库表名
