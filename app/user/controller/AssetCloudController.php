 ...
 */
class AssetCloudController extends AdminBaseController
{
    ...
    {
        $accessKeyId='LTAIx5mnLeGSWbBN';
        $accessKeySecret='Fhl7sY6tdBPSP08Ag9Ttw9sdwpwIu5';
        ...
        if ($this->request->isPost()) {
            ...
            $this->assign('tab', $tab);
            return $this->fetch(":clouduploader");
